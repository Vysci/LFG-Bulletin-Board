...
GBB.dungeonTagsLoc={
	...
	deDE =langSplit({
		...
		--["LBRS"] = 	{},
		--["UBRS"] =	{},
		["RAMPS"] = 	"bw bollwerk boll bolwerk",
		["BF"] = 	"bk blutkessel kessel",
		["SP"] = 	"sklave sklaven sklavenunterkünfte sklavenunterkunft slave",
		["UB"] = 	"tiefensumpf ts tiefen",
		["MT"] = 	"managruft",
		["CRYPTS"] = 	"auchenaikrypta krypta krypt",
		["SETH"] = 	"sethekhallen sethekkhallen",
		["OHB"] = 	"flucht vorgebirge hügelland höhlen hdz hdz1",
		["MECH"] = 	"mech mechanar mecha",
		["BM"] = 	"morast hdz hdz2 höhlen morrast morasst",
		["MGT"] = 	"terrasse terasse terrase",
		["SH"] = 	"zerschmetterte hallen zh",
		["BOT"] = 	"botanika bota",
		["SL"] = 	"schlabby schattenlabyrinth schattenlaby laby",
		["SV"] = 	"dampfkammer dk dampf",
		["ARC"] = 	"arkatraz arka ark akatraz",
		["KARA"] = 	"kara kz karazhan",
		["GL"] = 	"gl gruul gruuls gruul's unterschlupf",
		["MAG"] = 	"mag magtheridon magtheridon's magth kammer mk maggi maggy",
		["SSC"] = 	"ssc serpentshrine serpentshine schlangenschrein",
		["ZA"] = 	"za zulaman zul-aman zaman aman zul'aman",
		["EYE"] = 	"eye tk",
		["HYJAL"] = 	"hyjal hs hyj",
		["BT"] = 	"black bt st",
		["SWP"] = 	"swp sunwell plateau plataeu sunwel sonnenbrunnenplateau sonnenbrunnen",
		--["ONY"] = 	{},
		["MC"]  = 	"kern",
		--["ZG"]  = 	{},
		--["AQ20"] = 	{},
	...
	ruRU = langSplit({
		...
		["SP"] = "узилище узилише улилище",
		["UB"] = "нижетопь нт нежитопь",
		["MT"] = "маны гм манатомбс манатомбы томбы мана томбс манатобс манатомб манатомс",
		["CRYPTS"] = "аукенайские аг аукенские аукинайские аук",
		["SETH"] = "сетеккские залы сз сетеки сеттек сетекские сетеков сетеккскиезалы",
		["OHB"] = "Старые предгорья Хилсбрада спх пв хилсбрад хилбсрад",
		["MECH"] = "механар кбм механар ",
		["BM"] = "Черные топи",
		["MGT"] = "Терраса магистров тм",
		["SH"] = "разрушенные рз разрушенных",
		["BOT"] = "ботаника кбб ботанику",
		["SL"] = "темный тёмный  лаберинт лабиринт шл",
		["SV"] = "резервуар паровое паравое паровые",
		["ARC"] = "аркатрац кба алькатрац аркатрас алькатрас",
