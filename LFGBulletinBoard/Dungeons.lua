...
function GBB.GetDungeonNames()
	...
	local dungeonNamesLocales={ 
		deDE ={
			...
			["RAMPS"] = 	"Höllenfeuerzitadelle: Bollwerk",
			["BF"] = 	"Höllenfeuerzitadelle: Blutkessel",
			["SP"] = 	"Echsenkessel: Sklavenunterkünfte",
			["UB"] = 	"Echsenkessel: Tiefensumpf",
			["MT"] = 	"Auchindoun: Managruft",
			["CRYPTS"] = 	"Auchindoun: Auchenaikrypta",
			["SETH"] = 	"Auchindoun: Sethekkhallen",
			["OHB"] = 	"Höhlen der Zeit: Vorgebirge des Alten Hügellands",
			["MECH"] = 	"Festung der Stürme: Mechanar",
			["BM"] = 	"Höhlen der Zeit: Schwarzer Morast",
			["MGT"] = 	"Terrasse der Magister",
			["SH"] = 	"Höllenfeuerzitadelle: Zerschmetterte Hallen",
			["BOT"] = 	"Festung der Stürme: Botanika",
			["SL"] = 	"Auchindoun: Schattenlabyrinth",
			["SV"] = 	"Echsenkessel: Dampfkammer",
			["ARC"] = 	"Festung der Stürme: Arkatraz",
			["KARA"] = 	"Karazhan (10)",
