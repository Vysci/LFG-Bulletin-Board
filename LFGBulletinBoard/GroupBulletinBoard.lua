...
function GBB.FilterDungeon(dungeon, isHeroic)
	...
	return GBB.DBChar["FilterDungeon"..dungeon] and ((GBB.DBChar["Heroic"] == true and isHeroic) or (GBB.DBChar["Normal"] == true and not isHeroic) or GBB.GameType == "VANILLA") and
