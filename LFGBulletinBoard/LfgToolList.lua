...
local boardHeaderContextMenuApi = {
	fold = {
	...
	foldAll = function() setAllHeadersCollapsed(true) end,
	unfoldAll = function() setAllHeadersCollapsed(false) end,
}
...
local dungeonHeaderClickHandler = function(self, clickType, isMouseDown)
	...
	elseif clickType == "RightButton" then
		...
		GBB.CreateBulletinBoardContextMenu(self, dungeonKey, boardHeaderContextMenuApi)
	end
end
...
local requestEntryClickHandler = function(self, clickType)
	...
	if clickType == "LeftButton" then
		...
		GBB.CreateBulletinBoardContextMenu(self, req)
	end
end
